...
vim.api.nvim_create_autocmd({ "BufRead", "BufNewFile" }, {
	desc = "Set ansible filetype for yaml files in ansible projects",
	pattern = { "**/*.yml", "**/*.yaml" },
	callback = function(args)
		...
		while parent ~= "/" and parent ~= "" do
			local ansible_cfg = parent .. "/ansible.cfg"
			local roles_dir = parent .. "/roles"
			if vim.uv.fs_stat(ansible_cfg) or vim.uv.fs_stat(roles_dir) then
				vim.bo.filetype = "yaml.ansible"
				return
			end
